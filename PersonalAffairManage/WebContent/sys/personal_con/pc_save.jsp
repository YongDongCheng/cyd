...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/>  添加个人关系
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/pc?method=addObject" method="post">
	
		<!-- 本段标题（分段标题） -->
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="${pageContext.request.contextPath }/sys/style/images/item_point.gif"> 个人关系信息&nbsp;
        </div>
		<!-- 本段表单字段 -->
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="id" class="InputStyle" value="${pc.id}"/> *
							</td>
</tr>
<tr>
